                    ...
                    <div class="widget-block widget-item widget-style">
                        ...
                        <div class="widget-content widget-content-padding">
                            <div class="form-group">
                                ...
                                @endif
                                {!! Form::text('website_url',null,[ 'id'=>'website_url' , 'class'=>'field-style input-text', 'placeholder'=>'Website URL']) !!}
                            </div>
                        </div>
                    </div>
...
{{--                                <option value="">Choose an Option</option>--}}
                                @forelse($services as $item)
                                    <option value="{{ $item->id }}" {{ old('service_id') === $item->id ? "selected" : "" }}>{{ $item->title }}</option>
                                @empty
                                @endforelse
                            </select>
                        </div>
                        ...
                        <div class="widget-content widget-content-padding widget-content-padding-side">
                            <div class="form-group row no-gutters">
                                ...
                                <div class="col-12 field-style custom-select-field">
                                    <div class="thumbnail-image-upload">
                                        <div>
                                            <label for="logo-image" id="logo-label" class="thumbnail-label"><img id="logo-preview" src="{{ asset('assets/admin/img/base/icons/image.svg') }}"></label>
