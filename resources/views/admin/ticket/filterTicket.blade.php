            ...
            <div class="widget-block widget-item widget-style">
                <div class="heading-widget">
                    <div class="row align-items-center">
                        <div class="col-10">
                            <span class="widget-title">All Tickets</span>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="center" style="padding-left: 0px;">
                                    <a title="Messages" href="{{ route('ticket.message', $item->id) }}" class="table-btn table-btn-icon table-btn-icon-plus">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <td style="vertical-align: middle;" colspan="8">
                                    <div class="row align-items-center">
                                        <div class="col-4">
                                            Show items {{ $tickets->firstItem() }} to {{ $tickets->lastItem() }} from {{ $tickets->total() }} item (pages {{ $tickets->currentPage() }} from {{ $tickets->lastPage() }})
                                        </div>
