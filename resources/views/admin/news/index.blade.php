                        ...
                        <div class="heading-widget">
                            <div class="row align-items-center">
                                ...
                                <div class="col-2 left">
                                    <a href="{{ url('admin/blog/create') }}" class="submit-form-btn">Add News</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table align-items-center">
                                    ...
                                    @foreach ($news as $item)
                                        <tr>
                                            ...
                                            <td class="center">
                                                <a href="{{ route('news.edit', $item->id) }}" class="table-btn table-btn-icon table-btn-icon-edit"><i class="zmdi zmdi-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    ...
                                    <tr>
                                        <td style="vertical-align: middle;" colspan="8">
                                            <div class="row align-items-center">
                                                <div class="col-4">
                                                    Show items {{ $news->firstItem() }} to {{ $news->lastItem() }} from {{ $news->total() }} item (pages {{ $news->currentPage() }} from {{ $news->lastPage() }})
                                                </div>
