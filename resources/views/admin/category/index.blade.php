                        ...
                        <div class="heading-widget">
                            <div class="row align-items-center">
                                ...
                                <div class="col-2 left">
                                    <a href="{{ url('admin/categories/create') }}" class="submit-form-btn">New Category</a>
                                </div>
                            </div>
                        </div>

                        <div class="widget-content">
                            <form action="{{ route('categories.destroy') }}" method="post" onsubmit="return confirm('<?php echo "Are you sure you want to delete the selected items?";?>');">
                                @csrf
                                <table class="table align-items-center">
                                    ...
                                    @foreach ($categories as $item)
                                        <tr>
                                            ...
                                            <td class="center">
                                                <a href="{{ route('categories.edit', $item->id) }}" class="table-btn table-btn-icon table-btn-icon-edit"><i class="zmdi zmdi-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
