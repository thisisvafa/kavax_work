...
@section('content')
    <section class="form-section">
        {!! Form::open(['route'=>'blog-categories.store', 'id'=>'form']) !!}
        <div class="row">
            <div class="col-12">
                <div class="row">
                    {{-- Category Content --}}
                    <div class="col-12">
                        <div class="widget-block widget-item widget-style">
                            ...
                            <div class="widget-content widget-content-padding">
                                <div class="form-group row no-gutters">
                                    ...
                                    @endif
                                    {!! Form::text('name',null,[ 'id'=>'name' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'Enter Category Name', 'required']) !!}
                        ...
                        <button type="submit" class="submit-form-btn create-btn">Create Category</button>
                    </div>
                </div>
            </div>
        </div>
