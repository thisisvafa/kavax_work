...
<span class="icon">
    ...
    <span class="text">Create New Review</span>
@endsection

@section('content')
    <section class="form-section">
        {!! Form::open(['route'=>'reviews.store', 'id'=>'form', 'enctype' => 'multipart/form-data']) !!}
        <div class="row">
            <div class="col-12">
                <div class="row">
                    {{-- Review Content --}}
                        ...
                        <div class="widget-block widget-item widget-style">
                            ...
                            <div class="widget-content widget-content-padding">
                                <div class="form-group row no-gutters">
                                    ...
                                    @endif
                                    {!! Form::text('name',null,[ 'id'=>'name' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'Enter Client Name', 'required']) !!}
                                ...
                                <div class="form-group row no-gutters">
                                    ...
                                    @endif
                                    {!! Form::text('company',null,[ 'id'=>'company' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'Enter Client company', 'required']) !!}
                                ...
                                <div class="form-group row no-gutters">
                                    ...
                                    @endif
                                    {!! Form::text('description',null,[ 'id'=>'company' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'Enter Description'], 'required') !!}
