    ...
    <section class="report-table">
                    ...
                    <div class="widget-block widget-item widget-style">
                        <div class="heading-widget">
                            <div class="row align-items-center">
                                <div class="col-10">
                                    <span class="widget-title">All Reviews</span>
                                </div>
                                <div class="col-2 left">
                                    <a href="{{ url('admin/reviews/create') }}" class="submit-form-btn">New Category</a>
                                </div>
                            </div>
                        </div>

                        <div class="widget-content">
                            <form action="{{ route('reviews.destroy') }}" method="post" onsubmit="return confirm('<?php echo "Are you sure you want to delete the selected items?";?>');">
                                @csrf
                                <table class="table align-items-center">
                                    ...
                                    @foreach ($reviews as $item)
                                        <tr>
                                            ...
                                            <td class="center">
                                                <a href="{{ route('reviews.edit', $item->id) }}" class="table-btn table-btn-icon table-btn-icon-edit"><i class="zmdi zmdi-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    ...
                                    <tr>
                                        <td style="vertical-align: middle;" colspan="8">
                                            <div class="row align-items-center">
                                                <div class="col-4">
                                                    Show items {{ $reviews->firstItem() }} to {{ $reviews->lastItem() }} from {{ $reviews->total() }} item (pages {{ $reviews->currentPage() }} from {{ $reviews->lastPage() }})
                                                </div>
        ...
        @else
            <div class="widget-block widget-item widget-style center no-item">
                ...
                <h2>No item found!</h2>
                <div class="create-item"><a href="{{ url()->current() }}/create">Add New Review</a></div>
            </div>
        @endif
