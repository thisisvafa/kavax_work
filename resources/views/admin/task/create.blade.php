...
@section('content')
    <section class="form-section">
        {!! Form::open(['route'=>'tasks.store', 'id'=>'form']) !!}
                        ...
                        <div class="widget-block widget-item widget-style">
                            ...
                            <div class="widget-content widget-content-padding">
                                <div class="form-group row no-gutters">
                                    ...
                                    @endif
                                    {!! Form::text('name',null,[ 'id'=>'name' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'Enter Task Name', 'required']) !!}
                        ...
                        <div class="widget-block widget-item widget-style">
                            ...
                            <div class="widget-content widget-content-padding">
                                    ...
                                    <div class="form-group row no-gutters">
                                        ...
                                        @endif
                                        {!! Form::input('datetime-local','start_date',null,[ 'id'=>'start_date' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'Enter Task Start Date']) !!}
                                        <div class="col-12">
                                    ...
                                    <div class="form-group row no-gutters">
                                        ...
                                        @endif
                                        {!! Form::input('datetime-local','end_date',null,[ 'id'=>'end_date' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'Enter Task End Date']) !!}
                                        <div class="col-12">
                            ...
                            <div class="widget-content widget-content-padding">
                                ...
                                <div class="form-group row no-gutters">
                                    @if($errors->has('category'))
                                        <span class="message-show">{{ $errors->first('category') }}</span>
                                    @endif
                                    <div class="col-12 field-style">
                                    ...
                                    {{-- Publish Status --}}
                                    {!! Form::label('categories','Task Category',['class'=>'col-12']) !!}
                                </div>

                            </div>
                        </div>
                        <button type="submit" class="submit-form-btn create-btn">Create Task</button>
                    </div>
                </div>
            </div>
        </div>
