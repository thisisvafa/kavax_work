...
@section('content')
    <section class="form-section">
        {!! Form::open(['route'=>'invoices.store', 'id'=>'form']) !!}
                        ...
                        <div class="widget-block widget-item widget-style">
                            ...
                            <div class="widget-content widget-content-padding">
                                <div class="form-group row no-gutters">
                                    ...
                                    @endif
                                    {!! Form::text('invoice_number', '#'.str_pad($invoice_number+1, 8, "0", STR_PAD_LEFT) ,[ 'id'=>'name' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'Enter invoice Number', 'required']) !!}
                                ...
                                <div class="form-group row no-gutters">
                                    ...
                                    @endif
                                    {!! Form::text('invoice_name',null,[ 'id'=>'name' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'Enter invoice Name', 'required']) !!}
                                ...
                                <div class="form-group row no-gutters">
                                    ...
                                    @endif
                                    {!! Form::textarea('description',null,[ 'id'=>'description' , 'class'=>'col-12 field-style input-text',
