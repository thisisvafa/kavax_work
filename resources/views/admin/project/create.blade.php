...
@section('content')
    <section class="form-section">
        {!! Form::open(['route'=>'projects.store', 'id'=>'form']) !!}
        <div class="row">
            <div class="col-5">
                <div class="row">
                    {{-- Project Content --}}
                        ...
                        <div class="widget-block widget-item widget-style">
                            ...
                            <div class="widget-content widget-content-padding">
                                <div class="form-group row no-gutters">
                                    ...
                                    @endif
                                    {!! Form::text('project[name]',null,[ 'id'=>'name' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'Enter Project Name', 'required']) !!}
                                ...
                                <div class="form-group row no-gutters">
                                    ...
                                    @endif
                                    {!! Form::textarea('project[description]',null,[ 'id'=>'description' , 'class'=>'col-12 field-style input-text',
                                ...
                                <div class="form-group row no-gutters">
                                    ...
                                    @endif
                                    {!! Form::textarea('project[objective]',null,[ 'id'=>'objective' , 'class'=>'col-12 field-style input-text', 'style' => 'min-height: 80px;', 'placeholder'=>'Enter Project Objective']) !!}
                                    <div class="col-12">
                                ...
                                <div class="form-group row no-gutters">
                                    ...
                                    @endif
                                    {!! Form::text('project[budget]',null,[ 'id'=>'budget' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'Enter Project Budget']) !!}
                                    <div class="col-12">
                        ...
                        <div class="widget-block widget-item widget-style">
                            ...
                            <div class="widget-content widget-content-padding">
                                ...
                                <div class="form-group row no-gutters">
                                    ...
                                    @endif
                                    {!! Form::input('datetime-local','project[start_date]',null,[ 'id'=>'start_date' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'Enter Project Start Date']) !!}
                                    <div class="col-12">
                                ...
                                <div class="form-group row no-gutters">
                                    ...
                                    @endif
                                    {!! Form::input('datetime-local','project[end_date]',null,[ 'id'=>'end_date' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'Enter Project End Date']) !!}
                                    <div class="col-12">
                                ...
                                <div class="form-group row no-gutters">
                                    ...
                                    @endif
                                    {!! Form::number('project[progress]',0,[ 'id'=>'progress' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'Enter Project Progress']) !!}
                                    <div class="col-12">
                                ...
                                <div class="form-group row no-gutters">
                                    ...
                                    @endif
                                    {!! Form::number('project[employee_size]',0,[ 'id'=>'employee_size' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'Enter Employee size']) !!}
                                    <div class="col-12">
            ...
            <div class="col-3">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <button type="submit" class="submit-form-btn create-btn">Create Project</button>
                    </div>
                </div>
            </div>
        </div>
