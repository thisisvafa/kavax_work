                    ...
                    <div class="widget-block widget-item widget-style">
                        <div class="heading-widget">
                            <div class="row align-items-center">
                                <div class="col-12">
                                    <span class="widget-title">All Contacts</span>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table align-items-center">
                                    ...
                                    @foreach ($Contacts as $item)
                                        <tr>
                                            ...
                                            <td class="center">
                                                <a href="{{ route('contacts.edit', $item->id) }}" class="table-btn table-btn-icon table-btn-icon-edit"><i class="zmdi zmdi-eye"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    ...
                                    <tr>
                                        <td style="vertical-align: middle;" colspan="8">
                                            <div class="row align-items-center">
                                                <div class="col-4">
                                                    Show items {{ $Contacts->firstItem() }} to {{ $Contacts->lastItem() }} from {{ $Contacts->total() }} item (pages {{ $Contacts->currentPage() }} from {{ $Contacts->lastPage() }})
                                                </div>
