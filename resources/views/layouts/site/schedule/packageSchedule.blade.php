...
for ($i = 1; $i <= 7; $i++) { $date=date('Y-m-d', strtotime('+1 day', strtotime($date))); $weekOfdays[]=date('Y-m-d', strtotime($date)); } return $weekOfdays; } @endphp <section class="text-center my-5  py-5">
    <div class="booking-box">
        <div class="col-lg-6 col-md-6 col-sm-12 offset-lg-2 offset-md-2">
            <h3 style="text-align: center; font-size: 30px; color: white; clear: both;display: inline-block;overflow: hidden; ">Looking for a Different Plan? Book a Free Consultation Call</h3>
        </div>
            ...
            <div class="slider-small center col-md-6 col-lg-4 col-sm-12 booking-slider">
                ...
                <div class="item" style="width: 100px;">
                    <div class="date item list-group-item">
                        ...
                        <label for="{{ $item['details']['date'] }}_" class="{{ ($item['details']['name_day'] == "Sat" || $item['details']['name_day'] == "Sun") ? 'py-5 disable-date':'py-5' }} text-center">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="https://kavax.co.uk/app/auth/" method="get">
                        <div class="slider center fade " style="margin: auto;margin-top: 30px; width: 90%;padding: 30px 0px 40px 0px;">
                            @foreach ($data as $key => $item)
                            <div class="item ">
                                <div class="date item list-group-item">
                                    ...
                                    <label for="{{ $item['details']['date'] }}" class="{{ ($item['details']['name_day'] == "Sat" || $item['details']['name_day'] == "Sun") ? 'py-5 disable-date':'py-5' }} text-center">
                                        <div>
                                            {{ $item['details']['name_day'] }}
                                        </div>
                                        <div>
            ...
            $('#sch-btn-open').on('click', function(e) {
                ...
                $('#newBooking').on('shown.bs.modal', function(e) {
                    ...
                    $('.slider').slick({
                        ...
                        slidesToScroll: detectDevice() == "mobile" ? 3 : 5,
                    });
