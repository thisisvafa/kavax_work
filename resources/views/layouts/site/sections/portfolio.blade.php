                ...
                <div class="gallery">
                    ...
                    <ul class="gallery-list js-gallery">
                        ...
                        <li class="gallery-item all {{ preg_replace("/\s+/", "", $item->service->title) }}" onclick="window.location.href='{{ url('portfolio/') .'/'. $item->slug }}'">
                            <a href=" {{ url('portfolio/') .'/'. $item->slug }}" data-original-width="800" data-original-height="1200"><img src="{{asset('storage/portfolio/thumbnail').'/'.\App\Model\Attachments::find($item->thumbnail)->path}}" width="482" height="203" alt=""></a>
                        </li>
                        @endforeach
                    </ul>
                </div>
