@extends('layouts.site.master')@section('page-title', 'Branding  Packages')
...
@section('content')
    ...
    <section class="intro-section">
        <div class="section-bg">
            ...
            <img class="bg-img" src="{{ asset('assets/site/images/base') }}/header-image/branding.png"
                 alt="A young diverse team of digital experts">
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 col-sm-8 col-12">
                        ...
                        <div class="title-heading">Branding Packages</div>
                        <div class="section-text">
                            Build trustworthiness and security amongst your audience.
    ...
    <section class="single-case-study gradient-page">
        <div class="container">
            ...
            <p class="describePackage">Our designers are masters of the latest trends, and they’ll create the perfect
                logo and brand identity that folks will always</p>
            ...
            <div class="packages">
                ...
                <div class="case-study-package-item">
                    ...
                    <ul class="features" id="features-3">
                        ...
                        <li>Business card design</li>
                        <li>Letterhead design</li>
                        <li>Company visual identity design</li>
                        <li>Catalogue design</li>
                        <li>Rebranding</li>
                        <li>Organisational colour palette</li>
                        <li>Package design (for product-based companies)</li>
                        <li>Introductory teaser</li>
                    </ul>
            ...
            <div class="text-section">
                <p>
                    A branding package is a collection of digital, printed, or physical resources used to create a
                    uniform image of a brand.
                </p>
                <p>
                    Try to associate your favourite brand with something. What comes first to your mind? A logo, package
                    branding, colours, or, maybe, an elegant font used for a company’s name? These are all branding
                    elements included in a standard branding kit.
                </p>
                <p>
                    A great logo builds that instant connection with your audience. And business cards, letterhead, and
                    social media graphics all work together to show customers you mean business.
                </p>
                <p>
                    A branding package is a set of digital and physical resources developed to establish a brand's
                    image. Each item in the package reflects the desired style that brings together a company’s assets
                    and communicates a cohesive message across channels. The consistency of these details is what helps
                    to define your brand and builds trustworthiness and security amongst your audience. It also paves
                    the way for extensive marketing changes and provides a company with everything necessary for
                    effective brand promotion.
                </p>
            </div>
            <img src="{{ asset('assets/site/images/base') }}/case-study-2.jpg" style="width:100%"/>
